...
import { PlayerInterface } from 'src/app/models/user.interface';
...
export class RegisterComponent implements OnInit {
  //userForm es de tipo FormGroup porque va a ser una "agrupación" de datos dentro de un formulario. Es decir, userForm es mi objeto formulario.
  ...
  constructor(private formBuilder: FormBuilder) {
    ...
    this.userForm = this.formBuilder.group({
      ...
      age: ["", [Validators.required, Validators.min(17), Validators.max(50)]],
